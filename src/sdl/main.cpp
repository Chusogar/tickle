...
#include <machine/elevatob.h>
#include <machine/gng.h>
#include <machine/mrdo.h>
#include <machine/phoenix.h>
#include <machine/tehkanwc.h>
#include <machine/shaolins.h>
#include <machine/minivadr.h>
...
void dummy()
{
	...
	delete GnG::createInstance();
	delete MrDo::createInstance();
	delete Phoenix::createInstance();
	delete TehkanWCDriver::createInstance();
	delete Shaolins::createInstance();
	delete MiniVadr::createInstance();
